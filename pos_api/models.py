...
class Manager(models.Model):
    ...
    cardholder_commission = models.DecimalField(max_digits=10,decimal_places=2,default=0)
    merchant_commission = models.DecimalField(max_digits=10,decimal_places=2,default=0)
